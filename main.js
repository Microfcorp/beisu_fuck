...
if(nonLOL.indexOf("сидоренко") != -1 || nonLOL.indexOf("болдышев") || nonLOL.indexOf("бабаринов")){
  alert("Согласно приказу ректор №У-428 от 01.02.2026, посещаемость в группе 12002210 может ставить только самопровозглашенная Лиза");
}
